import { Settings, User, Building2, FileText, Bell, Image as ImageIcon, CheckCircle2, AlertTriangle, MessageSquare } from 'lucide-react';
...
export const settingsHelpDescription =
  'Perfil do usuário, dados da empresa, WhatsApp (Evolution), configuração fiscal, logo, cor da marca e notificações.';
        ...
        <div className="space-y-6">
          <Card className="border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-transparent dark:from-blue-900/20">
            <CardHeader>
              ...
              <CardDescription>Perfil, empresa, WhatsApp (Evolution), fiscal, notificações e aparência. Dados obrigatórios para emissão de notas e funcionamento do sistema.</CardDescription>
            </CardHeader>
          </Card>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <FeatureCard icon={<FileText className="h-5 w-5 text-purple-500" />} title="Dados fiscais" description="IE, Código IBGE, ambiente SEFAZ, certificado A1. Obrigatório para emissão de NF-e/NFC-e." badge="Fiscal" delay={2 * STAGGER} />
            ...
            <FeatureCard icon={<MessageSquare className="h-5 w-5 text-green-600" />} title="WhatsApp" description="Conecte o número da loja via Evolution para cobranças e mensagens automáticas (plano Pro)." badge="Cobrança" delay={5 * STAGGER} />
          </div>
        </div>
      ),
    },
      ...
      content: (
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <StepItem number={1} text="Preencha todos os dados fiscais: CNPJ, IE, Código IBGE, CEP, ambiente SEFAZ e certificado A1 (.pfx)." emphasis="Sem isso, a emissão de NF-e/NFC-e pode falhar." />
              <StepItem number={2} text="Salve. A logo e a cor da marca podem ser alteradas na mesma seção ou em Empresa." />
            </CardContent>
          </Card>
          <Card>
            <CardHeader><CardTitle>WhatsApp e cobranças</CardTitle><CardDescription>Uma instância por empresa na Evolution API.</CardDescription></CardHeader>
            <CardContent className="space-y-3">
              <StepItem number={1} text="No card WhatsApp (Evolution), toque em Conectar e escaneie o QR no aplicativo WhatsApp da loja." />
              <StepItem number={2} text="Somente com WhatsApp conectado você pode ativar as mensagens automáticas de cobrança de parcelas (plano Pro)." emphasis="As mensagens saem do número conectado, não de um número global." />
            </CardContent>
          </Card>
        </div>
      ),
      ...
      content: (
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <TroubleshootItem problem="Erro ao emitir nota: dados fiscais incompletos" solution="Volte em Configurações e preencha CNPJ, IE, Código IBGE, CEP, CSC (NFC-e), certificado A1 e ambiente SEFAZ." />
