      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <FeatureCard icon={<Package className="h-5 w-5 text-blue-500" />} title="Relatório de Produtos" description="Lista todos os produtos da loja (o período não é usado — sempre inclui todos os produtos)." delay={2 * STAGGER} />
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3">
                ...
                <TipItem icon={<Package className="h-4 w-4 text-blue-500" />} text="Relatório de Produtos: com qualquer data o sistema sempre lista todos os produtos da loja." />
              </ul>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              ...
              <TroubleshootItem problem="Relatório vazio" solution="Confirme que existem dados no período selecionado (vendas ou notas). No Relatório de Produtos, sempre são listados todos os produtos da loja." />
            </CardContent>
          </Card>
        </div>
      ),
